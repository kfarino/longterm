...
- `scripts/` — bot, dashboard server, Monarch pulls, Calendar sync, `seed-from-examples.mjs`, scheduled-task installers.
- `data/*.mjs` — test suites and build scripts (fixtures only; no real household data).
- `dashboard_v5.html` — pure renderer.
- `docs/` — design specs + setup playbook.
- `claude.md` — project context for an AI assistant.
